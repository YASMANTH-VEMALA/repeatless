  ...
  return (
    <div aria-hidden className={`absolute inset-0 overflow-hidden bg-black pointer-events-none ${className}`}>
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 16, mixBlendMode: "screen" }}>
        {spots.map((pos, i) => (
          <motion.div
            ...
            className="absolute flex w-[200vw] h-[80vh] -translate-x-1/2 justify-center pointer-events-none"
            style={{
              left: `${pos}%`,
              top: beamTop,
              mixBlendMode: "screen",
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 31 }}>
        {[35, 50, 65].map((pos) => (
          <div key={pos} className="absolute flex flex-col items-center" style={{ left: `${pos}%`, top: rigTop, transform: "translate(-50%, -4px)" }}>
            <div
      ...
      <div className="absolute pointer-events-none w-full h-[110px] bg-linear-to-b from-black/80 to-transparent blur-xl" style={{ zIndex: 29, top: "4%", left: 0 }} />
...
export function VolumetricStudio({
  className,
  children,
}: {
  className?: string;
  ...
  return (
    <section className={clsx("relative w-full h-full min-h-[600px] bg-black overflow-hidden font-sans", className)}>
